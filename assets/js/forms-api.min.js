	...
	! function t(n, r, i) {
		...
		1: [function(e, t, n) {
			...
			if (c(document.body).on("keyup", ".mc4wp-form input, .mc4wp-form textarea, .mc4wp-form select", o), c(document.body).on("change", ".mc4wp-form input, .mc4wp-form textarea, .mc4wp-form select", o), window.addEventListener("load", function() {
				...
				for (var f = s.listeners, l = 0; l < f.length; l++) a.on(f[l].event, f[l].callback);
				delete s.listeners
			}
				...
				for (var n = t.hash ? {} : "", r = t.serializer || (t.hash ? s : c), i = e && e.elements ? e.elements : [], o = Object.create(null), f = 0; f < i.length; ++f) {
					...
					if ((t.disabled || !l.disabled) && l.name && u.test(l.nodeName) && !a.test(l.type)) {
						...
						if ("checkbox" !== l.type && "radio" !== l.type || l.checked || (d = void 0), t.empty) {
							if ("checkbox" !== l.type || l.checked || (d = ""), "radio" === l.type && (o[l.name] || l.checked ? l.checked && (o[l.name] = !0) : o[l.name] = !1), !d && "radio" == l.type) continue
						} else if (!d) continue;
			...
			! function() {
				...
				function c(e, t, n) {
					if (d[e][n]) {
						var r, o, s = t.target || t.srcElement,
							...
							f = 0;
						l = 0;
						for (r in d[e][n]) d[e][n].hasOwnProperty(r) && (o = i(s, r, m[e].element)) && u.matchesEvent(n, m[e].element, o, "_root" == r, t) && (l++, d[e][n][r].match = o, c[l] = d[e][n][r]);
						for (t.stopPropagation = function() {
								t.cancelBubble = !0
							}, a = 0; a <= l; a++)
							if (c[a])
								for (f = 0; f < c[a].length; f++) {
									if (c[a][f].call(c[a].match, t) === !1) return void u.cancel(t);
				...
				function a(e, t, n, r) {
					if (this.element) {
						...
						var i, a = this.id;
						for (i = 0; i < e.length; i++) r ? s(this, e[i], t, n) : (d[a] && d[a][e[i]] || u.addEvent(this, e[i], function(e) {
							return function(t) {
								c(a, t, e)
							}
						}(e[i])), o(this, e[i], t, n));
				...
				var r = function(e, t, n) {
					for (var i in t)
						if (t.hasOwnProperty(i)) {
							var o = i,
								s = t[i];
							if (void 0 !== n && (o = n + "[" + i + "]"), s.constructor === Array) o += "[]";
							...
							if (c) {
								...
								switch (a) {
									...
									case "radio":
											case "checkbox":
											for (var u = 0; u < c.length; u++) c[u].checked = s.indexOf(c[u].value) > -1;
										break;
									case "select-multiple":
											for (var f = s.constructor == Array ? s : [s], l = 0; l < c.options.length; l++) c.options[l].selected |= f.indexOf(c.options[l].value) > -1;
										break;
									case "select":
											case "select-one":
		...
		7: [function(e, n, r) {
			! function(e) {
				...
				c.getListeners = function(e) {
					...
					for (r in o) o.hasOwnProperty(r) && (n = i(o[r], t)) !== -1 && o[r].splice(n, 1);
					return this
					...
					for (o in s)
						if (s.hasOwnProperty(o))
							for (n = s[o].slice(0), i = 0; i < n.length; i++) r = n[i], r.once === !0 && this.removeListener(e, r.listener), r.listener.apply(this, t || []) === this._getOnceReturnValue() && this.removeListener(e, r.listener);
					return this
