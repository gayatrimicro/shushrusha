		  	...
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="addpage.php">Add page</a></li>
                   	<li><a href="addmodelparts.php">Add model parts</a></li>
                    <!-- <li class="submenu">
                         <a href="#">
											...
											<div class="col-md-5">
												...
												<!-- <select class="form-control" id="select-1">
													...
													<div class="bfh-selectbox" data-name="selectbox3" data-value="12" data-filter="true">
													  ...
													  <!-- <div data-value="2">Holden</div>
													  <div data-value="3">Mazda</div>
													  <div data-value="4">Ford</div>
													  <div data-value="5">Honda</div>
													  <div data-value="6">Isuzu</div>
													  <div data-value="7">Mitsubishi</div>
													  <div data-value="8">Nissan</div>
													  <div data-value="9">Subaru</div>
													  <div data-value="10">Volkswagen</div>
													  <div data-value="11">Audi</div>
													  <div data-value="12">BMW</div> -->
													  <?php }
													  } ?>
													</div>
											</div>
